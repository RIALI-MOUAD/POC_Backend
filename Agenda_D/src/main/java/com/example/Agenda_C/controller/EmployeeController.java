...
public class EmployeeController {
    ...
    public Time contributePro(@RequestBody TimeRequest timeRequest){
...
/*
    ...
    public List<Time> fetchAllTimesInDate(@PathVariable LocalDateTime date){
        Long currentUser_id = userService.getloggedUser().getId();
        return timeRepository.findAllByUserId(currentUser_id,date);
    }
